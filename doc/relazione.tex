    ...
    \begin{tikzpicture}[scale=0.9]
      \begin{axis}[
        ...
        \addplot[
          ...
          coordinates {
            (400, 0.37) (500, 0.43) (600, 0.55)
            (700, 0.69) (800, 0.86) (900, 1.06)
            (1000, 1.38) (1100, 1.66) (1200, 2.20)
            (1300, 3.06) (1400, 3.31) (1500, 4.43)
          };
...
Per il calcolo del numero di operazioni al secondo sono stati utilizzati i dati riportati nella \autoref{tab:cuda_it_sizes}.
    ...
    \begin{tikzpicture}[scale=0.9]
      \begin{axis}[
        ...
        \addplot[
          ...
          coordinates {
            (400, 1.53) (500, 2.59) (600, 3.48)
            (700, 4.36) (800, 5.26) (900, 6.05)
            (1000, 6.39) (1100, 7.09) (1200, 6.94)
            (1300, 6.34) (1400, 7.31) (1500, 6.72)
        };
        \addlegendentry{\small{CUDA}}
      \end{axis}
    \end{tikzpicture}
...
La \autoref{fig:cuda_throughput} mostra il limite superiore di istruzioni stimato per OpenMP e CUDA.
Tale numero di istruzioni è approssimato a miliardi di operazioni per secondo.
In questo caso, il numero di operazioni al secondo per CUDA arriva fino a 7x rispetto a quello della versione OpenMP.
    ...
    \begin{tikzpicture}[scale=0.8]
        \begin{axis}[
          ...
          \addplot[ybar, fill=cyan] coordinates {
            (400, 1.48) (500, 2.77) (600, 3.43)
            (700, 3.93) (800, 5.04) (900, 5.69)
            (1000, 6.20) (1100, 6.59) (1200, 6.93)
            (1300, 5.88) (1400, 6.64) (1500, 6.28)
          };
        \end{axis}
    \end{tikzpicture}
...
con un picco di 7x in un caso favorevole.
