...
Ad ogni posizione la sorgente ed il rilevatore sono posi in modo opportuno con il fine di analizzare lo stesso oggetto da più
angolazioni diverse.
...
\begin{figure}[H]
  ...
  \caption{\label{fig:CT_polar_coordinates} Vista goniometrica di un raggio diretto dalla prima sorgente verso il centro del pixel
           ...
           Il ragionamento può essere generalizzato anche per gli altri pixel.}
\end{figure}
