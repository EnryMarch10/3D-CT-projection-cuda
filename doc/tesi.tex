...
\begin{abstract}
La tomografia computerizzata (TC) è una tecnica diagnostica ampiamente utilizzata negli ultimi anni, che sfrutta radiazioni
ionizzanti (o raggi X) per ottenere una rappresentazione tridimensionale dell'oggetto in esame.
...
Le informazioni ottenute vengono successivamente trasferite a un calcolatore, che ha il compito di convertirle in immagini 2D,
fondamentali per la ricostruzione del volume 3D dell'oggetto scansionato.
La TC consente di analizzare l'oggetto ricostruito, rivelando proprietà di densità della sua struttura interna precedentemente
...
in vari settori industriali, nella paleontologia, nell'archeologia ed in numerosi altri ambiti.

La TC è stata possibile grazie agli studi del matematico austriaco Johann Radon, che dimostrò teoricamente la possibilità di
ricostruire un oggetto tridimensionale a partire da un numero infinito di proiezioni bidimensionali dell'oggetto stesso.
